...
|------|-------------|---------------|------------|
| Bucket | Instance tracking and cleanup | `bucket = "miagobble/bucket@1.0.3"` | https://github.com/MiaGobble/Bucket |
...
| TracebackUtils | Utilities related to debug library | `traceback-utils = "miagobble/traceback-utils@1.0.1"` | https://github.com/MiaGobble/TracebackUtils |
| SeamStoryUtils | Utilities for Seam stories in UI Labs | `seam-story-utils = "miagobble/seam-story-utils@0.1.2"` | https://github.com/MiaGobble/SeamStoryUtils |
...
| ExpressivePrompts | Customizable UI to replace Roblox's default for ProximityPrompt instances | `expressive-prompts = "miagobble/expressive-prompts@1.1.0"` | https://github.com/MiaGobble/ExpressivePrompts |
...
Praxis is currently very early in development and is public to serve as a WIP.
